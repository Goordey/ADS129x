...
/*                                  Архітектуро-залежні функції                 */
  ...
  uint8_t TRANSMITTING(uint8_t data);               // Передача одного байту даних в перший фронт-енд по SPI
  void    UPDATE();                                 // Функція ініціювання прийому даних з першого фронт-енду. Запуск за перериванням по Data Ready
/********************************************************************************/
